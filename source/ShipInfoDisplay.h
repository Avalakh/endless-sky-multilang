...
private:
	...
	std::vector<std::string> attributeHeaderTooltipKeys;

	std::vector<std::string> tableLabels;
	std::vector<std::string> tableTooltipKeys;
	...
	std::vector<std::string> outfitTooltipKeys;
	int outfitsHeight = 0;

	std::vector<std::string> saleLabels;
	std::vector<std::string> saleValues;
	std::vector<std::string> saleTooltipKeys;
	int saleHeight = 0;

	std::vector<std::string> attributeTooltipKeys;
};
