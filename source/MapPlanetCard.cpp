		...
		planetName(object.DisplayName())
{
	...
	governmentName = Translation::TrGovernment(planet->GetGovernment()->DisplayName());
	string systemGovernmentName = Translation::TrGovernment(planet->GetSystem()->GetGovernment()->DisplayName());
