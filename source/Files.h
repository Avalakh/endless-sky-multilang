...
public:
	...
	// Directory of the executable (e.g. build/mingw/Debug when running from build).
	...
	// Directory for TTF fonts: data/fonts next to the executable (e.g. build/Debug/data/fonts).
